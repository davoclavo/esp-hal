...
- RMT: `Rmt::frequency`, `Channel::frequency`, `TxChannelCreator::frequency` and `RxChannelCreator::frequency` to query the actual configured RMT source clock rate (#5532)
